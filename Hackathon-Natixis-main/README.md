# Natixis Hackathon - AI Data Analyst

An intelligent chat interface for querying and analyzing anomaly data using natural language. Built with Nuxt 4, AI SDK, and NuxtHub.
